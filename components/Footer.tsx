// TODO: Replace placeholder hrefs with real social URLs once provided
const SOCIALS = [
  {
    label: 'X',
    href: 'https://x.com/trynothingai', // ← replace
    icon: (
  ...
  {
    label: 'TikTok',
    href: 'https://tiktok.com/@trynothingai', // ← replace
    icon: (
      <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true">
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/trynothingai', // ← replace
    icon: (
      <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true">
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/company/trynothingai', // ← replace
    icon: (
      <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true">
...
export function Footer() {
  return (
    ...
    >
      ...
      {/* Social icons */}
      <div className="flex items-center gap-[20px]" aria-label="Social links">
        {SOCIALS.map(s => (
          <a
            key={s.label}
            href={s.href}
            ...
            aria-label={s.label}
            className="link-ghost transition-colors"
